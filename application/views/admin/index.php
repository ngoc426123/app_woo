        ...
        <aside class="main-sidebar">
            <section class="sidebar">
                <ul class="sidebar-menu" data-widget="tree">
                    ...
                    <li><a href="<?php echo base_url("dashbroad") ?>"><i class="fa fa-dashboard text-red"></i><span>Bảng tổng quan</span></a></li>
                    <li class="treeview">
                        <a href="#">
                            <i class="fa fa-coffee text-yellow"></i> <span>Quản lý món</span>
